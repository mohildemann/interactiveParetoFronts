...
v.to.rast input=contour_lines layer="contour_lines_with_watershed_id_enerata" type="point,line,area" where="pos_rank in (9, 10, 18, 19, 24, 26, 30, 32, 34, 36, 37, 44, 48, 50, 51, 53, 59, 64, 65, 66, 72, 75, 76, 78, 80, 83, 84, 92, 96, 100, 102, 107, 111, 116, 119, 121, 123, 127, 129, 135, 141, 148, 150, 156, 158, 164, 165, 168, 170, 172, 173, 175, 179, 180, 181, 182, 184, 185, 189, 192, 196, 197, 200, 203, 204, 205, 212, 216, 217, 219, 220, 225, 229, 230, 232, 234, 238, 240, 247, 249, 252, 254, 260, 266, 282)" use="val" value=1 memory=300 output=selected_contour_lines_ras --overwrite
v.to.rast input=watersheds_shp layer="Basins_4" type="point,line,area" where="pos_rank in (9, 10, 18, 19, 24, 26, 30, 32, 34, 36, 37, 44, 48, 50, 51, 53, 59, 64, 65, 66, 72, 75, 76, 78, 80, 83, 84, 92, 96, 100, 102, 107, 111, 116, 119, 121, 123, 127, 129, 135, 141, 148, 150, 156, 158, 164, 165, 168, 170, 172, 173, 175, 179, 180, 181, 182, 184, 185, 189, 192, 196, 197, 200, 203, 204, 205, 212, 216, 217, 219, 220, 225, 229, 230, 232, 234, 238, 240, 247, 249, 252, 254, 260, 266, 282)" use="val" value=1 memory=300 output=protected_watersheds_ras --overwrite
...
r.univar -t map=rusle_ras separator=comma output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20\rusle_total.csv" --overwrite
r.out.gdal -t -m input=flowlengthraster output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/flowlength.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=rfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/r_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=kfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/k_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=lfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/l_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=sfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/s_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=lsfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/ls_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=pfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/p_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=cfactor_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/c_factor.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
r.out.gdal -t -m input=rusle_ras output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/rusle.tif" format=GTiff  createopt=TFW=YES,COMPRESS=LZW --overwrite
v.extract input=contour_lines  output=selected_contour_lines_shp layer="contour_lines_with_watershed_id_enerata" where="pos_rank in (9, 10, 18, 19, 24, 26, 30, 32, 34, 36, 37, 44, 48, 50, 51, 53, 59, 64, 65, 66, 72, 75, 76, 78, 80, 83, 84, 92, 96, 100, 102, 107, 111, 116, 119, 121, 123, 127, 129, 135, 141, 148, 150, 156, 158, 164, 165, 168, 170, 172, 173, 175, 179, 180, 181, 182, 184, 185, 189, 192, 196, 197, 200, 203, 204, 205, 212, 216, 217, 219, 220, 225, 229, 230, 232, 234, 238, 240, 247, 249, 252, 254, 260, 266, 282)"
v.extract input=watersheds_shp  output=selected_watersheds_shp layer="Basins_4" where="pos_rank in (9, 10, 18, 19, 24, 26, 30, 32, 34, 36, 37, 44, 48, 50, 51, 53, 59, 64, 65, 66, 72, 75, 76, 78, 80, 83, 84, 92, 96, 100, 102, 107, 111, 116, 119, 121, 123, 127, 129, 135, 141, 148, 150, 156, 158, 164, 165, 168, 170, 172, 173, 175, 179, 180, 181, 182, 184, 185, 189, 192, 196, 197, 200, 203, 204, 205, 212, 216, 217, 219, 220, 225, 229, 230, 232, 234, 238, 240, 247, 249, 252, 254, 260, 266, 282)"
v.out.ogr input=selected_contour_lines_shp output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/terraces.geojson" format=GeoJSON  --overwrite
v.out.ogr input=selected_watersheds_shp output="C:\Users\morit\AppData\Local\Temp\grassdata\3255ab2a58817c5184a5a00ad9582a7f\20/protected_watersheds.geojson" format=GeoJSON --overwrite
